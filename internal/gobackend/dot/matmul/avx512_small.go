...
func avx512SmallFloat32( //alt:f32
	...
	var oZero float32 //alt:f32|bf16
			...
			for k := 0; k < contractingSize; k++ {
				...
				for ; col+2*outputVecWidth <= rhsCrossSize; col += 2 * outputVecWidth {
					...
					if k > 0 {
						...
						zero := archsimd.BroadcastFloat32x16(0.0) //alt:f32|bf16
						//alt:f64 zero := archsimd.BroadcastFloat64x8(0.0)
						o0_0, o0_1 = zero, zero //alt:f32|bf16|f64
						o1_0, o1_1 = zero, zero //alt:f32|bf16|f64
						o2_0, o2_1 = zero, zero //alt:f32|bf16|f64
						o3_0, o3_1 = zero, zero //alt:f32|bf16|f64
					}

					o0_0 = l0.MulAdd(r0, o0_0) //alt:f32|bf16|f64
					o0_1 = l0.MulAdd(r1, o0_1) //alt:f32|bf16|f64
					o1_0 = l1.MulAdd(r0, o1_0) //alt:f32|bf16|f64
					o1_1 = l1.MulAdd(r1, o1_1) //alt:f32|bf16|f64
					o2_0 = l2.MulAdd(r0, o2_0) //alt:f32|bf16|f64
					o2_1 = l2.MulAdd(r1, o2_1) //alt:f32|bf16|f64
					o3_0 = l3.MulAdd(r0, o3_0) //alt:f32|bf16|f64
					o3_1 = l3.MulAdd(r1, o3_1) //alt:f32|bf16|f64
				...
				for ; col < rhsCrossSize; col++ {
					...
					if k == 0 {
						*(*float32)(unsafe.Pointer(outBase0)) = l0_scalar * r0 //alt:f32|bf16
						*(*float32)(unsafe.Pointer(outBase1)) = l1_scalar * r0 //alt:f32|bf16
						*(*float32)(unsafe.Pointer(outBase2)) = l2_scalar * r0 //alt:f32|bf16
						*(*float32)(unsafe.Pointer(outBase3)) = l3_scalar * r0 //alt:f32|bf16
		...
		for ; row < lhsCrossSize; row++ {
			for k := 0; k < contractingSize; k++ {
				...
				for ; col+inputVecWidth <= rhsCrossSize; col += inputVecWidth {
					...
					o0 = l0.MulAdd(r0, o0) //alt:f32|bf16|f64
				...
				for ; col < rhsCrossSize; col++ {
					...
					outBase := outputBase + uintptr(row*rhsCrossSize+col)*oSize
					if k == 0 {
						*(*float32)(unsafe.Pointer(outBase)) = l0_scalar * r0 //alt:f32|bf16
	...
	for range batchCount {
		for row := 0; row < lhsCrossSize; row++ {
			for col := 0; col < rhsCrossSize; col++ {
				...
				acc := archsimd.BroadcastFloat32x16(0.0) //alt:f32|bf16
				...
				res := avx512ReduceSumFloat32x16(acc) //alt:f32|bf16
				...
				*(*float32)(unsafe.Pointer(outputIdx)) = res //alt:f32|bf16
